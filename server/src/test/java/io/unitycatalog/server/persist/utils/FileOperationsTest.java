...
public class FileOperationsTest {
  ...
  public void testToStandardizedURIString() {
    ...
    assertThat(FileOperations.toStandardizedURIString(
    ...
    assertThat(FileOperations.toStandardizedURIString("file:/tmp/mydir"))
        .isEqualTo("file:///tmp/mydir");
    assertThat(FileOperations.toStandardizedURIString("file:/tmp/"))
        .isEqualTo("file:///tmp/");
    assertThat(FileOperations.toStandardizedURIString("file:/tmp"))
        .isEqualTo("file:///tmp");
    assertThat(FileOperations.toStandardizedURIString("file:/"))
        .isEqualTo("file:///");
